  ...
  return (
    <div className="p-8 bg-white rounded-[2.5rem] border-2 border-gray-100 shadow-2xl max-w-2xl mx-auto">
      <div className="flex flex-col gap-2 mb-8">
        ...
        <p className="text-text-brand">Select your usual study spot for faster deliveries.</p>
      </div>
        ...
        {CAMPUS_SPOTS.map((spot) => (
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs text-text-brand">{spot.description}</span>
            </div>
            {selected === spot.id && (
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="text-sm text-text-brand">
          {savedSpot
